                    ...
                    <div class="list-group list-group-flush">
                        @forelse($course->lessons as $lesson)
                            <a href="?lesson={{ $lesson->id }}"
                                class="list-group-item list-group-item-action d-flex align-items-center gap-3 py-3 {{ request('lesson') == $lesson->id ? 'bg-light fw-bold text-primary border-start border-primary border-4' : '' }}">
                                ...
                                <div>
                                    <small class="text-uppercase text-muted" style="font-size: 0.7rem;">Modul
            ...
            <div class="col-lg-8">
                <div class="card shadow rounded-4 overflow-hidden mb-4">
                    ...
                    @php
                        ...
                        $currentLesson =
                            $course->lessons->firstWhere('id', $currentLessonId) ?? $course->lessons->first();
                    @endphp

                    @if ($currentLesson)
                        <div class="ratio ratio-16x9 bg-dark">
                            <iframe src="https://www.youtube.com/embed/{{ $currentLesson->video_id ?? 'dQw4w9WgXcQ' }}"
                        ...
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">
                                {!! nl2br(e($currentLesson->description ?? 'Tidak ada deskripsi untuk materi ini.')) !!}</p>
                        </div>
                    @else
                        <div
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    <div class="d-flex align-items-center gap-3">
                        <img src="https://ui-avatars.com/api/?name={{ $course->teacher->name }}&background=random"
