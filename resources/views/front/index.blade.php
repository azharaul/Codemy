    ...
    <section class="py-5 bg-light" id="courses">
        <div class="container px-5 my-5">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('front.course.index') }}" class="btn btn-outline-primary fw-bold px-4">Lihat Semua
                    Kursus</a>
            </div>
        </div>
    </section>
